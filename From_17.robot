########################################
# โครงการพัฒนา ปตท. และกลุ่ม ปตท. ในอดีต #
########################################
...
${From}     xpath=/html/body/div/div[1]/main/div[2]/div/div[2]/div[1]/div/div/div/div[17]/div
${Name}        Test Data
${save}     xpath=/html/body/div[3]/div[3]/div/div[2]/div[2]/button[1]
${Edit}     xpath=//*[@id="editOnTableStandard_53"]

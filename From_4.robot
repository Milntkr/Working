...
${From}     xpath=/html/body/div/div[1]/main/div[2]/div/div[2]/div[1]/div/div/div/div[4]/div
${ADD}      xpath=//*[@id="addOnTableStandard"]
${Name}        Test Data
${save}     xpath=/html/body/div[3]/div[3]/div/div[2]/div[2]/button[1]
${Edit}     xpath=//*[@id="editOnTableStandard_12345"]
${text_id}     ส
${Agency}   id=sNameAgency
***Keywords***
Open website
...
Add Basic Data
    ...
    Click Element   ${ADD}  
    Sleep    2
    Click Element   xpath=/html/body/div/div[1]/main/div[2]/div/div[2]/div/form/div/div/div[2]/div/div/div
    Sleep    1
    Input Text      ${Agency}  ${text_id}
    Sleep    2
    Click Element   id=sNameAgency-option-1
    Sleep    2
Button Save Data
...
Edit Basic Data
    ...
    Click Element   xpath=/html/body/div/div[1]/main/div[2]/div/div[2]/div/form/div/div/div[2]/div/div/div
    Sleep    1
    press keys      id=sNameAgency        CTRL+a+BACKSPACE
    Sleep    10
    Input Text      ${Agency}  ${text_id}
    Sleep    2
    Click Element   id=sNameAgency-option-1

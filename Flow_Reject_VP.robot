...
Reject My Projects
    ...
    Sleep    2
    Click Element    id=BtnApprove_MyProject_1
    Sleep    2
    #เปลี่ยนโปรเจคได้ (Ex.BtnApprove_MyProject_3)
    Scroll Element Into View    xpath=//*[@id="reject-project-view"]
    Sleep    2
    Click Element    xpath=//*[@id="reject-project-view"]
    Sleep    2
    Click Element    xpath=//*[@id="reject-project"]
    Sleep    2

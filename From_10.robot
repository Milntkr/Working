...
${From}     xpath=/html/body/div/div[1]/main/div[2]/div/div[2]/div[1]/div/div/div/div[10]/div
${ADD}      xpath=//*[@id="addOnTableStandard"]
${Name}        Test Data
${save}     xpath=/html/body/div[2]/div[3]/div/div[2]/div[2]/button[1]
${Edit}     xpath=//*[@id="editOnTableStandard_42"]
${text}     1234 Data
${id_Close}     id=close-dialog
...
Delete Basic Data
    ...
    Scroll Element Into View    xpath=//*[@id="root"]/div[1]/main/div[2]/div/div[2]/div[2]/div[2]/div/div[3]/div
    Sleep    2
    Click Element      xpath=//*[@id="root"]/div[1]/main/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div[2]/div/div/div/div[10]/div[1]
...
Watch Detail Job
    ...
    Scroll Element Into View    xpath=//*[@id="root"]/div[1]/main/div[2]/div/div[2]/div[2]/div[2]/div/div[3]/div
    Sleep    2
    Click Element        id=previewOnTableStandard_1
    Sleep    5
    Click Element        ${id_Close}
    Sleep    5
#--------------------------------------
Log Out Admin

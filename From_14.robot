...
${From}     xpath=/html/body/div/div[1]/main/div[2]/div/div[2]/div[1]/div/div/div/div[14]/div
${ADD}      xpath=//*[@id="addOnTableStandard"]
${Name}        Test Data
${save}     xpath=/html/body/div[3]/div[3]/div/div[2]/div[2]/button[1]
${Edit}     xpath=//*[@id="editOnTableStandard_186"]
...
Add Basic Data
    ...
    Sleep    1
    Click Element    id=sMenuCollect-option-2
    Sleep    2
